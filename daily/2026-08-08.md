...
Summary: Focused on two core filtering patterns: selecting parcels by zoning in SQL (DuckDB) and filtering open parks in Python (GeoPandas). Practiced translating spatial questions into code and checked results for accuracy.
